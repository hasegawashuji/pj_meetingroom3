...
class MonthWithScheduleCalendar(mixins.MonthWithScheduleMixin, generic.TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'app/month_with_schedule.html', {
        ...
        for booking in booking_data:
            ...
            if (booking_hour in calendar) and (booking_room, booking_date in calendar[booking_hour]):
                if dct == booking_date:
                    ...
                    # calendar[booking_hour][booking_room, booking_date] = False
...
class StaffView(View):
    def get(self, request, *args, **kwargs):
        staff_data = Staff.objects.all().select_related('user')
